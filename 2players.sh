...
team="Walk_faster" #using parmsfile t0
host="localhost"
port=3100
paramsfile=paramfiles/helloParams.txt
mhost="localhost"
...
for ((i=1;i<=$NUM_PLAYERS;i++)); do
	...
	1|2)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 0 --paramsfile paramfiles/defaultParams_t3.txt &#> /dev/null &
	...
	3|4)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 1 --paramsfile paramfiles/defaultParams_t3.txt &#>  /dev/null &
	...
	5|6)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 2 --paramsfile paramfiles/defaultParams_t3.txt &#> /dev/null &
	...
	*)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 4 --paramsfile paramfiles/defaultParams_t3.txt &#> /dev/null &
