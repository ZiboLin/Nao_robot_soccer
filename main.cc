...
void Run()
{
    ...
    if (agentType == "naoagent") {
        ...
        cout << "creating OptimizationBehaviorFixedKick" << endl;
        ...
        cout << "creating OptimizationBehaviorWalkForward" << endl;
