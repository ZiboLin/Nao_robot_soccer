...
for ((i=1;i<=$NUM_PLAYERS;i++)); do
	...
	1|2)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 2 --paramsfile paramfiles/ziboParams.txt --simplesoccer &#> /dev/null &
	...
	5|6)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 1 --paramsfile paramfiles/ziboParams.txt --simplesoccer &#> /dev/null &
	...
	7|8)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 4 --paramsfile paramfiles/ziboParams.txt --simplesoccer  &#> /dev/null &
